...
#This model is an example of the implementation if the Duplicate Error is resolved
GlazedFacade = DMN('C:/Users/camil/OneDrive - UGent/Ugent/AJ/23-24/Masterthesis/MODELS/DMN/1.Inplanting en toegangswegen/final/1-2_GlazedFacadeAboveBuildingSegmentRegulation.dmn')
...
print(GlazedFacade.possible_values_of('FireResistanceFacade'))
print(GlazedFacade.possible_values_of('HorizontalDistanceFromFacade'))
print(GlazedFacade.possible_values_of('FireResistanceRoof'))
...
GlazedFacade.set_value('FireResistanceFacade', "EI_60")
GlazedFacade.set_value('HorizontalDistanceFromFacade', 2)
GlazedFacade.set_value('FireResistanceRoof', "EI_90")
